...
| --- | --- | ---: | ---: | ---: | ---: |
| `data\processed\local_eval_manifests\combined_balanced_48pf.jsonl` | low_risk_support_stable | 1 | 1.0000 | 1.0000 | 0 |
| `data\processed\local_eval_manifests\combined_balanced_48pf.jsonl` | operator_gap_oracle_miss | 31 | 0.0000 | 0.0000 | 0 |
| `data\processed\local_eval_manifests\combined_balanced_48pf.jsonl` | unseen_literal_high_risk | 7 | 0.0000 | 0.0000 | 7 |
| `data\processed\local_eval_manifests\hard_triad_full.jsonl` | low_risk_support_stable | 14 | 1.0000 | 1.0000 | 0 |
| `data\processed\local_eval_manifests\hard_triad_full.jsonl` | operator_gap_oracle_miss | 146 | 0.0000 | 0.0000 | 0 |
| `data\processed\local_eval_manifests\hard_triad_full.jsonl` | ranker_miss_oracle_hit | 2 | 0.0000 | 1.0000 | 0 |
| `data\processed\local_eval_manifests\hard_triad_full.jsonl` | unseen_literal_high_risk | 28 | 0.0000 | 0.0000 | 28 |
| `data\processed\local_eval_manifests\proxy_all_balanced_64pf.jsonl` | low_risk_support_stable | 3 | 1.0000 | 1.0000 | 0 |
| `data\processed\local_eval_manifests\proxy_all_balanced_64pf.jsonl` | operator_gap_oracle_miss | 33 | 0.0000 | 0.0000 | 0 |
| `data\processed\local_eval_manifests\proxy_all_balanced_64pf.jsonl` | ranker_miss_oracle_hit | 1 | 0.0000 | 1.0000 | 0 |
...
- `771472d6` risk=`operator_gap_oracle_miss` oracle_rank=`None` target=`-'?` top=`?'\\`
