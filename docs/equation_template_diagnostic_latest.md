...
| --- | --- | ---: | ---: | ---: | ---: |
| `data\processed\local_eval_manifests\combined_balanced_48pf.jsonl` | operator_gap_oracle_miss | 32 | 0.0625 | 0.0625 | 0 |
...
| `data\processed\local_eval_manifests\hard_triad_full.jsonl` | operator_gap_oracle_miss | 157 | 0.0764 | 0.0764 | 0 |
...
- `a3183159` risk=`operator_gap_oracle_miss` oracle_rank=`None` target=``{` top=`-]``