...
| --- | --- | ---: | ---: | ---: | ---: | ---: |
| `data\processed\local_eval_manifests\combined_balanced_48pf.jsonl` | expressible_oracle_miss | 7 | 0.5714 | 0.5714 | 1.0000 | 0 |
...
| `data\processed\local_eval_manifests\hard_triad_full.jsonl` | expressible_oracle_miss | 11 | 0.8182 | 0.8182 | 1.0000 | 0 |
...
| `data\processed\local_eval_manifests\hard_triad_full.jsonl` | ranker_miss_oracle_hit | 1 | 0.0000 | 1.0000 | 1.0000 | 0 |
...
- `a2ca3aae` risk=`operator_gap_oracle_miss` oracle_rank=`None` query=`</*[)` target=`\<?/` top=`)[[` target_expressible=`False`