...
- rows: `288`
- query accuracy: `0.7222`
- oracle@k: `0.7257`
- support-full rate: `0.9965`
- avg support accuracy: `0.9979`
- failure classes: `{"query_correct": 208, "query_wrong_after_support_fit": 79, "support_incomplete": 1}`

| family | n | query_acc | oracle@k | support_full | avg_support | failures | top signature buckets |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| bit | 48 | 0.2917 | 0.3125 | 1.0000 | 1.0000 | `{"query_wrong_after_support_fit": 34, "query_correct": 14}` | `{"binary_boolean_expr": 41, "affine": 7}` |
...
| bit_permutation | 48 | 0.2917 | 0.3125 | 1.0000 | `{"query_wrong_after_support_fit": 34, "query_correct": 14}` |
...
| family | n | query_acc | oracle@k | support_full | avg_support | failures | top signature buckets |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| bit | 57 | 0.4912 | 0.5263 | 1.0000 | 1.0000 | `{"query_wrong_after_support_fit": 29, "query_correct": 28}` | `{"binary_boolean_expr": 46, "affine": 9, "binary_invert>rotl>nibble": 1, "nibble": 1}` |
...
- rows: `709`
- query accuracy: `0.4993`
- oracle@k: `0.5205`
- support-full rate: `0.9788`
- avg support accuracy: `0.9850`
- failure classes: `{"query_correct": 354, "query_wrong_after_support_fit": 340, "support_incomplete": 15}`

| family | n | query_acc | oracle@k | support_full | avg_support | failures | top signature buckets |
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- |
| bit | 240 | 0.4500 | 0.5083 | 0.9917 | 0.9938 | `{"query_wrong_after_support_fit": 130, "query_correct": 108, "support_incomplete": 2}` | `{"binary_boolean_expr": 190, "affine": 42, "binary_invert>rotl>nibble": 2, "nibble": 1, "rotl>nibble": 1, "binary_invert>rotl>bitwise_or_constant": 1, "rotl": 1, "binary_invert>rotl>bitwise_or_constant>rotr": 1}` |
...
| bit_permutation | 239 | 0.4477 | 0.5063 | 0.9916 | `{"query_wrong_after_support_fit": 130, "query_correct": 107, "support_incomplete": 2}` |
