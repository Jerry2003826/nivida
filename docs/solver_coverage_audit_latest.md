...
- rows: `352`
- query accuracy: `0.7330`
- support-full rate: `0.9574`
- avg support accuracy: `0.9702`
- failure classes: `{"query_correct": 257, "query_wrong_after_support_fit": 80, "support_incomplete": 15}`
...
| equation | 64 | 0.1562 | 0.8594 | 0.8971 | `{"query_wrong_after_support_fit": 45, "query_correct": 10, "support_incomplete": 9}` | `{"template": 32, "evaluate_expression>add": 8, "eq_rule": 7, "position": 2, "template>]],]=[[lit,#],[lit,[],[pos,4]]": 1, "template>=[[lit,&],[lit,&],[pos,1]]": 1, "position>=,{=,%=,@=>,[=,\\=+,(={,+=,?=\\,%=>=/,[=/,": 1, "evaluate_expression>affine": 1}` |
...
| subtype | n | query_acc | support_full | failures |
| --- | ---: | ---: | ---: | --- |
| equation_template | 46 | 0.0652 | 1.0000 | `{"query_wrong_after_support_fit": 43, "query_correct": 3}` |
...
- rows: `709`
- query accuracy: `0.4795`
- support-full rate: `0.9478`
- avg support accuracy: `0.9630`
- failure classes: `{"query_correct": 337, "query_wrong_after_support_fit": 335, "support_incomplete": 37}`
...
| equation | 233 | 0.1631 | 0.9442 | 0.9608 | `{"query_wrong_after_support_fit": 182, "query_correct": 38, "support_incomplete": 13}` | `{"template": 131, "eq_rule": 26, "evaluate_expression>add": 12, "position": 10, "template>]]": 2, "template>]],]=[[lit,#],[lit,[],[pos,4]]": 1, "template>],[lit,\"]],]=[[lit,'],[pos,0]]": 1, "template>],[pos,3]]": 1}` |

### Weakest Subtypes

| subtype | n | query_acc | support_full | failures |
| --- | ---: | ---: | ---: | --- |
| equation_template | 190 | 0.0737 | 1.0000 | `{"query_wrong_after_support_fit": 176, "query_correct": 14}` |
