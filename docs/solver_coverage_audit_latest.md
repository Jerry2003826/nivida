...
- rows: `288`
- query accuracy: `0.7292`
- oracle@k: `0.7396`
- support-full rate: `0.9965`
- avg support accuracy: `0.9979`
- failure classes: `{"query_correct": 210, "query_wrong_after_support_fit": 77, "support_incomplete": 1}`
...
| --- | ---: | ---: | ---: | ---: | --- |
| equation_template | 39 | 0.0513 | 0.0513 | 1.0000 | `{"query_wrong_after_support_fit": 37, "query_correct": 2}` |
...
- failure classes: `{"query_correct": 357, "query_wrong_after_support_fit": 338, "support_incomplete": 14}`
...
| equation | 233 | 0.1760 | 0.1803 | 0.9442 | 0.9608 | `{"query_wrong_after_support_fit": 179, "query_correct": 41, "support_incomplete": 13}` | `{"template": 129, "eq_rule": 26, "evaluate_expression>add": 12, "position": 10, "template>]]": 2, "template>]],]=[[lit,#],[lit,[],[pos,4]]": 1, "template>],[lit,\"]],]=[[lit,'],[pos,0]]": 1, "template>],[pos,3]]": 1}` |

### Weakest Subtypes

| subtype | n | query_acc | oracle@k | support_full | failures |
| --- | ---: | ---: | ---: | ---: | --- |
| equation_template | 190 | 0.0895 | 0.0895 | 1.0000 | `{"query_wrong_after_support_fit": 173, "query_correct": 17}` |
