...
GENERATED_FILES = (
    ...
    *ANSWER_FOCUSED_OUTPUTS,
    ...
    RESEARCH_BREAKOUT_DIR / "mixed_answer_short_train.jsonl.provenance.json",
    RESEARCH_BREAKOUT_DIR / "mixed_answer_short_valid.jsonl",
    RESEARCH_BREAKOUT_DIR / "mixed_answer_short_valid.jsonl.provenance.json",
    RESEARCH_BREAKOUT_DIR / "equation_rescue_train.jsonl",
    RESEARCH_BREAKOUT_DIR / "equation_rescue_train.jsonl.provenance.json",
    RESEARCH_BREAKOUT_DIR / "equation_rescue_valid.jsonl",
    RESEARCH_BREAKOUT_DIR / "equation_rescue_valid.jsonl.provenance.json",
    RESEARCH_BREAKOUT_DIR / "bit_rescue_train.jsonl",
    RESEARCH_BREAKOUT_DIR / "bit_rescue_train.jsonl.provenance.json",
    RESEARCH_BREAKOUT_DIR / "bit_rescue_valid.jsonl",
    RESEARCH_BREAKOUT_DIR / "bit_rescue_valid.jsonl.provenance.json",
...
def _cloud_preflight_command() -> list[str]:
    return _python(
        ...
        "smoke_head6",
        "--candidate",
        "answer_only_continuation=artifacts/adapter_stage2_official_balanced_answer_only",
        "--candidate",
    ...
    fast_steps = [
        ...
        GateStep(
            ...
            _python(
                ...
                "tests/test_finalize_cloud_eval_batch1.py",
                "tests/test_research_next_step_planner.py",
                "tests/test_shell_syntax.py",
                "tests/test_stage2_annotation_provenance.py",
                "tests/test_stage2_answer_focused_builder.py",
                "tests/test_stage2_support_cache_hydrator.py",
                "-q",
            ),
        ),
