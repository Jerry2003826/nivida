...
def test_full_mode_plans_required_command_order() -> None:
    ...
    assert commands == [
        ...
        "python scripts/check_cloud_eval_inputs.py --dry-run --eval-inputs smoke_head6 --candidate answer_only_continuation=artifacts/adapter_stage2_official_balanced_answer_only --candidate bit_rescue_v2_20260430_trained=artifacts/adapter_stage2_bit_rescue_v2 --output data/processed/cloud_eval_preflight_plan.json",
